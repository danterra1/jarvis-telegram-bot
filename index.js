...
// ---------- Location sharing ----------
async function sendLocationRequest(chatId, reason) {
    ...
    if (toolUseBlocks.length > 0) {
      ...
      for (const block of toolUseBlocks) {
        ...
        if (block.name === 'remember_fact') {
          ...
          await sendLocationRequest(chatId, block.input.reason);
